...
const ClockIn: React.FC = () => {
    ...
    const [userDetails, setUserDetails] = useState({"id":"32235da5-7dcc-4dc0-a698-89daed0e7629","clockIn":"2025-02-07T05:28:08.224Z","clockOut":"2025-02-07T05:28:08.224Z","totalHours":null,"status":"clocked_in","employeeCode":"EMP2","employeeId":"bfd21a74-d75c-4285-bf0d-a4a9479c95d6","employeeFirstName":"Jane","employeeLastName":"Smith","employeeFullName":"Jane Smith","date":"2025-02-07"})
    ...
    if(true){
      ...
      return <ClockOut getClockInDetails={getClockInDetails} userDetails={userDetails} />;
    }
