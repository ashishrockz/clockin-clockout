...
const ClockIn: React.FC = () => {
      ...
      <div className="bg-gray-900 text-white h-screen p-5">
        ...
        <div className="mt-15 flex flex-col items-center">
          <h2 className="font-semibold text-xl mt-3 mb-3">
            Clocked-in successfully at 2:27
          </h2>
          <h5 className="font-semibold text-lg mt-3 mb-3">
            Have a great day ahead, {user?.firstName} {user?.lastName}
          </h5>
          <button className="border border-white w-70 h-10 rounded-sm mt-3 mb-3">
            Close
          </button>
        </div>
      </div>
  ...
  return (
    <div className="bg-gray-900  text-white h-screen p-5">
      <DateTime />
      <div className="mt-15 flex flex-col items-center">
        <h3 className="font-bold text-3xl mt-3 mb-3">
          Welcome, {user?.firstName} {user?.lastName}
        </h3>
        <h4 className="font-medium text-lg mt-3 mb-3">
